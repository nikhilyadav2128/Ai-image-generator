...
const gridGallery = document.querySelector(".gallery-grid");
 ...
 const API_KEY = "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";// hugging face api key
...
const generateImages = async (selectedModel, imageCount, aspectRatio, promptText) => {
    ...
    // Generate images here inside generateImages
...
const createImageCards = async (selectedModel, imageCount, aspectRatio, promptText) => {
    ...
    // Await the image generation to complete
...
const handleFormSubmit = async (e) => {
    ...
    // Await the image generation to complete
    await createImageCards(selectedModel, imageCount, aspectRatio, promptText);
  };
  

// Fill the Input with random example
